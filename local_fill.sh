...
prov = ManageIQ::Providers::Openshift::ContainerManager.new(:hostname => "'$1'", :port => 8443,  :name =>"local", :zone => Zone.first)
prov.save
AuthToken.create(:name => "ManageIQ::Providers::Openshift::ContainerManager local", :authtype => "bearer", :userid => "_", :resource_id => prov.id, :resource_type => "ExtManagementSystem", :type => "AuthToken", :auth_key => "'$2'").save
